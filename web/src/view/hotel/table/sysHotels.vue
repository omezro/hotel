  ...
  <div>
    ...
    <div class="gva-table-box">
      ...
      >
        ...
        <el-table-column align="left" label="酒店名称" prop="name" width="120" />
        <el-table-column align="left" label="登陆平台:1-携程,2-飞猪,3-美团" prop="platform" width="120">
          <template #default="scope">{{ formatBoolean(scope.row.platform) }}</template>
        </el-table-column>
        <el-table-column align="left" label="酒店经理姓名" prop="manager" width="120" />
        <el-table-column align="left" label="结算方式" prop="settlementType" width="120" />
        <el-table-column align="left" label="转账账户" prop="transferAccount" width="120" />
        <el-table-column align="left" label="签约人" prop="signatory" width="120" />
        <el-table-column align="left" label="催单电话" prop="phone" width="120" />
        <el-table-column align="left" label="备注" prop="mark" width="120" />
        <el-table-column align="left" label="房型ID" prop="roomId" width="120" />
        <el-table-column align="left" label="按钮组">
          <template #default="scope">
            <el-button type="text" icon="edit" size="small" class="table-button" @click="updateSysHotelsFunc(scope.row)">变更</el-button>
...
const getTableData = async() => {
  const table = await getSysHotelsList({ page: page.value, pageSize: pageSize.value, ...searchInfo.value })
  if (table.code === 0) {
...
// 更新行
const updateSysHotelsFunc = async(row) => {
...
// 删除行
const deleteSysHotelsFunc = async(row) => {
